/**
 * Move Videos to Production S3 Structure
 * Moves consolidated videos to the desired S3 bucket structure
 * 
 * Usage: node move-to-production-s3.js [COURSE_ID]
 */
...
const SOURCE_FOLDER = `videos/course/${COURSE_ID}/`;
const TARGET_FOLDER = `ibyet_production/courses/Stock_Market_Investing_Course/`;
...
async function moveToProductionS3() {
  try {
    console.log('🚀 Moving videos to production S3 structure...');
    ...
    for (const video of videos) {
      try {
        ...
        console.log('📋 Copying to production location...');
        const copyParams = {
          Bucket: BUCKET_NAME,
        ...
        // Uncomment the following lines to delete source files
        /*
        try {
    ...
    try {
      ...
      console.log(`✅ Production folder verification: ${targetVideos.length} videos`);
      ...
      console.log('⚠️  Could not verify production structure:', verifyError.message);
    }
    ...
    // Summary
    console.log('\n🎉 Production S3 move completed!');
    console.log('==================================');
    console.log(`   - Videos moved: ${movedCount}`);
    console.log(`   - Videos skipped: ${skippedCount}`);
    console.log(`   - Errors: ${errorCount}`);
    console.log(`   - Total size: ${(totalSize / 1024 / 1024 / 1024).toFixed(2)} GB`);
    console.log(`   - Production folder: ${TARGET_FOLDER}`);
    
    if (movedCount > 0) {
      console.log('\n✅ Videos successfully moved to production structure!');
      console.log('🚀 Your course now follows the desired S3 organization!');
      console.log('\n📋 Final S3 Structure:');
      console.log('   ibyet-investing/');
      console.log('   └── ibyet_production/');
      console.log('       └── courses/');
      console.log('           └── Stock_Market_Investing_Course/');
    ...
    console.error('❌ Production move failed:', error.message);
...
if (require.main === module) {
  console.log('🚀 Move to Production S3 Tool');
  console.log('==============================');
  moveToProductionS3();
}

module.exports = { moveToProductionS3 };

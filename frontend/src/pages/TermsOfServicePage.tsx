      ...
      <div className="bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4 pb-2 sm:pb-3 md:pb-4">Terms of Service</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a href="#acceptance" className="flex items-center text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 dark:hover:text-cyan-300">
              <Shield className="h-4 w-4 mr-2" />
              Acceptance of Terms
            </a>
            <a href="#services" className="flex items-center text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 dark:hover:text-cyan-300">
              <Users className="h-4 w-4 mr-2" />
              Services Description
            </a>
            <a href="#accounts" className="flex items-center text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 dark:hover:text-cyan-300">
              <Lock className="h-4 w-4 mr-2" />
              User Accounts
            </a>
            <a href="#payments" className="flex items-center text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 dark:hover:text-cyan-300">
              <FileText className="h-4 w-4 mr-2" />
              Payment Terms
            </a>
            <a href="#intellectual-property" className="flex items-center text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 dark:hover:text-cyan-300">
              <Shield className="h-4 w-4 mr-2" />
              Intellectual Property
            </a>
            <a href="#privacy" className="flex items-center text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 dark:hover:text-cyan-300">
              <Shield className="h-4 w-4 mr-2" />
              Privacy & Data
            </a>
          </div>
        ...
        <div className="space-y-8">
          {/* Acceptance of Terms */}
          <section id="acceptance" className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
          ...
          {/* Services Description */}
          <section id="services" className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
          ...
          {/* User Accounts */}
          <section id="accounts" className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
          ...
          {/* Payment Terms */}
          <section id="payments" className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">4. Payment Terms</h2>
            <div className="prose prose-gray max-w-none">
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                All course purchases are final. Payments are processed securely through our payment partners. Refunds are handled according to our refund policy, which can be found in our Help Center.
              </p>
            </div>
          </section>

          {/* Intellectual Property */}
          <section id="intellectual-property" className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="prose prose-gray max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">License to Use</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
          ...
          {/* Privacy & Data */}
          <section id="privacy" className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">6. Privacy & Data Protection</h2>
            <div className="prose prose-gray max-w-none">
              <p className="text-gray-600 dark:text-gray-300 mb-4">
          ...
          <section className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">7. Prohibited Uses</h2>
            <div className="prose prose-gray max-w-none">
              <p className="text-gray-600 dark:text-gray-300 mb-4">You may not use our platform to:</p>
              <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2 mb-4">
          ...
          {/* Disclaimers */}
          <section className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">8. Disclaimers and Limitations</h2>
            <div className="prose prose-gray max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Educational Content</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <div className="prose prose-gray max-w-none">
              ...
              <div className="bg-gray-100 dark:bg-gray-900/50 rounded-lg p-4">
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  <strong>WhatsApp:</strong> <a className="text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300" href={`https://wa.me/${config.SUPPORT_WHATSAPP.replace(/[^\\d]/g, '')}`} target="_blank" rel="noopener noreferrer">{config.SUPPORT_WHATSAPP}</a>
                </p>
              </div>
            </div>
          </section>
        ...
        <div className="mt-12 bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-8 text-center border border-gray-300 dark:border-gray-700">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">If you have any questions about these Terms of Service, please contact us:</h2>

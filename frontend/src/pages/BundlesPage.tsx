...
const BundlesPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white">
      {/* Header Section */}
      <div className="bg-gradient-to-br from-gray-100 via-gray-50 to-gray-100 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 py-12 sm:py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-center text-base sm:text-lg md:text-xl max-w-3xl mx-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-xl transition-all duration-200 text-sm font-semibold ${
                          selectedCategory === category
                            ...
                            : 'bg-gray-200 dark:bg-gray-700/50 border border-gray-300 dark:border-gray-600/50 hover:bg-gray-300 dark:hover:bg-gray-700 hover:border-gray-400 dark:hover:border-gray-500 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white'
                        }`}
                      >
                        {category}
                      </button>
            ...
            {hasActiveFilters && (
              <div className="px-4 sm:px-5 md:px-6 py-3 bg-gray-100 dark:bg-gray-800/50 border-t border-gray-200 dark:border-gray-700/30">
                <div className="flex items-center flex-wrap gap-2">
                  <span className="text-xs font-semibold text-gray-600 dark:text-gray-500 uppercase tracking-wide mr-1">{t('bundles_page.active_filters', 'Active:')}</span>
                  {searchTerm && (
            ...
            <div className="flex items-center gap-3">
              <div className="px-3 py-1.5 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700/30">
                <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                  {totalItems > 0 ? (
                    <>
                      <span className="text-cyan-600 dark:text-cyan-400 font-bold">{bundles.length}</span>
        ...
        {/* Bundles Grid - Full width for horizontal cards */}

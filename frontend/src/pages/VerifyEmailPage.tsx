...
const VerifyEmailPage = () => {
  ...
  const getStatusIcon = () => {
    switch (status) {
      case 'loading':
        return <Loader2 className="h-16 w-16 text-cyan-400 animate-spin" />;
      case 'success':
          ...
          <div className="text-center">
            ...
            {status === 'error' && (
              <div className="mt-6 space-y-3">
                ...
                <button
                  onClick={() => navigate('/')}
                  className="w-full bg-gray-800 hover:bg-gray-700 text-white py-2 px-4 rounded-lg transition-colors duration-200 border border-gray-600"
                >

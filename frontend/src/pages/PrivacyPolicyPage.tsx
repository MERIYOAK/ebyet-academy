        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-sm text-cyan-200 mt-4">
              {t('privacy_content.last_updated')} {lastUpdated}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-gray-800 rounded-lg shadow-sm border border-gray-700 p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a href="#information-collection" className="flex items-center text-cyan-400 hover:text-cyan-300">
              <Database className="h-4 w-4 mr-2" />
              Information We Collect
            </a>
            <a href="#how-we-use" className="flex items-center text-cyan-400 hover:text-cyan-300">
              <Eye className="h-4 w-4 mr-2" />
              How We Use Information
            </a>
            <a href="#information-sharing" className="flex items-center text-cyan-400 hover:text-cyan-300">
              <Users className="h-4 w-4 mr-2" />
              Information Sharing
            </a>
            <a href="#data-security" className="flex items-center text-cyan-400 hover:text-cyan-300">
              <Lock className="h-4 w-4 mr-2" />
              Data Security
            </a>
            <a href="#your-rights" className="flex items-center text-cyan-400 hover:text-cyan-300">
              <Shield className="h-4 w-4 mr-2" />
              Your Rights
            </a>
            <a href="#cookies" className="flex items-center text-cyan-400 hover:text-cyan-300">
        ...
        <div className="space-y-8">
          ...
          <section id="information-collection" className="bg-gray-800 rounded-lg shadow-sm border border-gray-700 p-8">
            <h2 className="text-2xl font-bold text-white mb-4">{t('privacy_content.information_collection_title')}</h2>
            <div className="prose prose-gray max-w-none">
          ...
          {/* How We Use Information */}
          <section id="how-we-use" className="bg-gray-800 rounded-lg shadow-sm border border-gray-700 p-8">
            <h2 className="text-2xl font-bold text-white mb-4">{t('privacy_content.how_we_use_title')}</h2>
            <div className="prose prose-gray max-w-none">
              <p className="text-gray-300 mb-4">
          ...
          {/* Information Sharing */}
          <section id="information-sharing" className="bg-gray-800 rounded-lg shadow-sm border border-gray-700 p-8">
            <h2 className="text-2xl font-bold text-white mb-4">{t('privacy_content.information_sharing_title')}</h2>
            <div className="prose prose-gray max-w-none">
              <p className="text-gray-300 mb-4">
          ...
          {/* Data Security */}
          <section id="data-security" className="bg-gray-800 rounded-lg shadow-sm border border-gray-700 p-8">
            <h2 className="text-2xl font-bold text-white mb-4">{t('privacy_content.data_security_title')}</h2>
            <div className="prose prose-gray max-w-none">
              <p className="text-gray-300 mb-4">
              ...
              <h3 className="text-lg font-semibold text-white mb-3">Data Breach Response</h3>
              <p className="text-gray-300">
          ...
          {/* Your Rights */}
          <section id="your-rights" className="bg-gray-800 rounded-lg shadow-sm border border-gray-700 p-8">
            <h2 className="text-2xl font-bold text-white mb-4">{t('privacy_content.your_rights_title')}</h2>
            <div className="prose prose-gray max-w-none">
              <p className="text-gray-300 mb-4">
              ...
              <h3 className="text-lg font-semibold text-white mb-3">Marketing Communications</h3>
              <p className="text-gray-300 mb-4">
              ...
              <h3 className="text-lg font-semibold text-white mb-3">Data Processing Restrictions</h3>
              <p className="text-gray-300">
          ...
          <section id="cookies" className="bg-gray-800 rounded-lg shadow-sm border border-gray-700 p-8">
            <h2 className="text-2xl font-bold text-white mb-4">{t('privacy_content.cookies_title')}</h2>
            <div className="prose prose-gray max-w-none">
              <p className="text-gray-300 mb-4">
              ...
              <h3 className="text-lg font-semibold text-white mb-3">Third-Party Analytics</h3>
              <p className="text-gray-300 mb-4">
          ...
          {/* Policy Updates */}
          <section className="bg-gray-800 rounded-lg shadow-sm border border-gray-700 p-8">
            <h2 className="text-2xl font-bold text-white mb-4">{t('privacy_content.changes_title')}</h2>
            <div className="prose prose-gray max-w-none">
              <p className="text-gray-300 mb-4">
                {t('privacy_content.changes_content')}
              </p>
            </div>
          </section>
        ...
        <div className="mt-12 bg-gradient-to-r from-gray-800 to-gray-900 rounded-2xl p-8 text-center border border-gray-700">
          <h2 className="text-2xl font-bold text-white mb-4">{t('privacy_content.contact_questions')}</h2>
